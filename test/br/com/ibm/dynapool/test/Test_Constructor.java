...
public class Test_Constructor {
	...
	protected List<Csv_Constructor> FileCSVAcc = new LinkedList<>();
	protected List<Csv_Constructor> FileCSVAut = new LinkedList<>();
	protected List<Csv_Constructor> FileCSVUsr = new LinkedList<>();
	...
	public void startReport() {
		...
		FileCSVAcc = csvEng.readSpreadsheetCSV(prop.readPropertiesFile("csv_fullFlowAccount"));
		FileCSVAut = csvEng.readSpreadsheetCSV(prop.readPropertiesFile("csv_fullFlowAutomata"));
//		FileCSVUsr = csvEng.readSpreadsheetCSV(prop.readPropertiesFile("csv_fullFlowUser"));
